...
#ifndef __OPENGL41_H__
#define __OPENGL41_H__
...
namespace renderer
{
	class OpenGL
	{
		public:
			...
			void GetLookAt(glm::vec3 &vEye, glm::vec3 &vCenter);
			...
			/// \return glm::vec4 - the vertex colour currently active
			const glm::vec4& GetColour()	{ return m_GLState.vColour; }
